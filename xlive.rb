...
module XLiveServices
  ...
  class MarketplacePublic
    ...
    def self.GetOfferGUID(titleId, offerID)
      "#{offerID}-0000-4000-8000-0000#{titleId.to_s(16)}"
    end

    def GetOfferGUID(titleId, offerID)
      self.class.GetOfferGUID(titleId, offerID)
    end
...
response = marketplace.GetOfferDetailsPublic(locale, marketplace.GetOfferGUID(0x425307d6, 'e0000001'))
